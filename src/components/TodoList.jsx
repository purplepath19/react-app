...
const filteredTasks = tasks.filter(task=>task.text !== taskToDelete.text); 
      ...
      <ul>
        {tasks.map((task) => {
          ...
          return (
            ...
            <h1> {task.date} </h1>
            {/* <p>  {task.text} </p> */}
            <input onChange={onChangeHandler} type="text" placeholder="Add a new task" value={value} />
            ...
            <div className="buttons-container"> 
              ...
              <button className="delete-button" onClick={()=> deleteTask(task)}> ✔ </button>
